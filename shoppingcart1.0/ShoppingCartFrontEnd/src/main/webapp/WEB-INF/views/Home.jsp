...
<body  >
 <!-- style="background-color: #f7f7f7;"  background="C:\Users\Avinay\Downloads\images\images "-->
...
<div style="text-align: center;">
  	...
  	<div class="carousel-inner">
  	 	...
  	 	<div class="item active">
  			...
  			<div class="fill"> <img  src="C:\Users\Avinay\Downloads\images\images\diw.gif"alt="#" width="100%"
								height="75%"></div>					
  		</div> 
  		
  			<div class="item ">
  			<!-- Set the first background image using inline CSS below. -->
  			<div class="fill" ><img  src="C:\Users\Avinay\Downloads\images\images\a.gif" alt="#" width="100%"
								height="75%"></div>
  		</div>
  		
  		<div class="item ">
  			<!-- Set the first background image using inline CSS below. -->
  			<div class="fill" ><img  src="C:\Users\Avinay\Downloads\images\images\di4.jpg" alt="#" width="100%"
								height="75%"></div>
  		</div>
  		...
  		<div class="item">
  			...
  			<div class="fill"> <img  src="C:\Users\Avinay\Downloads\images\images\yes.PNG" alt="#" width="100%"
								height="75%"></div>
  			...
  			<div class="item ">
  			<!-- Set the first background image using inline CSS below. -->
  			<div class="fill" ><img  src="C:\Users\Avinay\Downloads\images\images\ama.jpg" alt="#" width="100%"
								height="75%"></div>
  		</div>
  		<div class="item">
  			<!-- Set the second background image using inline CSS below.  -->
  			<div class="fill"> <img  src="C:\Users\Avinay\Downloads\images\images\2016.jpg" alt="#" width="100%"
								height="75%"></div>
							
  		</div>
  <!-- 		<div class="item">
  			Set the third background image using inline CSS below.
  			<div class="fill"> <img  src="C:\Users\Avinay\Downloads\images\images\di3.PNG"alt="#" width="100%"
								height="75%"></div>			
  		</div> -->
  	...
  	<div class="item">
  		...
  		<div class="fill"> <img  src="C:\Users\Avinay\Downloads\images\images\Raksh.jpg" alt="#" width="100%"
								height="75%"></div>
  	</div>
...
<footer class="footer-distributed">
	...
	<div class="footer-left">
		...
		<p class="footer-company-name">BUGATI&copy; 2016</p>
	</div>
	...
	<div class="footer-center">
		<div>
			...
			<p>
				<span>Bangalore</span> Karnatka, India
			</p>
		</div>
		<div>
		...
		<div>
			...
			<p>
				<a href="BUGATI:support@company.com">BUGATI.support@company.com</a>
			</p>
		</div>
	</div>
	...
	<div class="footer-right">
		<p class="footer-company-about">
			<span>About the company</span> BUGATI is India's fastest emerging
