						...
						<h4 class="title"><span class="text"><strong>Register</strong> Form</span></h4>
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
									<form:input type="text" path="mail" placeholder="Enter your email" class="input-xlarge"/>
								   </div>
								</div>
								<div class="control-group">
									<label class="control-label">Password:</label>
									<div class="controls">
										<form:input type="password" path="password" placeholder="Enter your password" class="input-xlarge" min="7" max="15"/>
								    </div>
								</div>							                            
								<div class="control-group">
