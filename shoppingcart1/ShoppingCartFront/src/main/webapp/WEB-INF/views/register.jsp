						...
						<h4 class="title"><span class="text"><strong>Login</strong> Form</span></h4>
							...
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">LoginUsername</label>
									<div class="controls">
							...
							<fieldset>
								<div class="control-group">
									...
									<div class="controls">
										...
										<form:input type="text" path="Username" placeholder="Enter your username" class="input-xlarge" id="username"/>
									</div>
								</div>
								<div class="control-group">
									...
									<form:input type="text" path="mail" placeholder="Enter your email" class="input-xlarge" id=" mail"/>
								   </div>
								</div>
								...
								<div class="control-group">
									...
									<form:input type="text" path="Contact" placeholder="Enter your contact address" class="input-xlarge" id="contact"/>
								   </div>
								</div>
								...
								<div class="control-group">
									...
									<form:errors path="password" cssStyle="color: #ff0000" />
										<form:input type="password" path="password" placeholder="Enter your password" class="input-xlarge" min="4" max="15"/>
								    </div>
								</div>							                            
								<div class="control-group">
