						...
						<ul class="thumbnails listing-products">
							<li class="span3">
								<div class="product-box">
									...
									<a href="product_detail.html"><img alt="" src=<c:url value="/lib/themes/images/ladies/9.jpg"/>></a><br/>
							...
							<li class="span3">
								<div class="product-box">
									<span class="sale_tag"></span>												
									<a href="product_detail.html"><img alt="" src=<c:url value="/lib/themes/images/ladies/7.jpg"/>></a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									<span class="sale_tag"></span>
									<a href="product_detail.html"><img alt="" src=<c:url value="/lib/themes/images/ladies/6.jpg"/>></a><br/>
							...
							<li class="span3">
								<div class="product-box">												
									<a href="product_detail.html"><img alt="" src=<c:url value="/lib/themes/images/ladies/3.jpg"/>></a><br/>
								...
								<div class="carousel-inner">
									<div class="active item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													<span class="sale_tag"></span>												
													<img alt="" src=<c:url value="/lib/themes/images/ladies/1.jpg"/>><br/>
													<a href="product_detail.html" class="title">Fusce id molestie massa</a><br/>
													<a href="#" class="category">Suspendisse aliquet</a>
													<p class="price">$261</p>
												</div>
									...
									<div class="item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													<img alt="" src=<c:url value="/lib/themes/images/ladies/2.jpg"/>><br/>
													<a href="product_detail.html" class="title">Tempor sem sodales</a><br/>
													<a href="#" class="category">Urna nec lectus mollis</a>
													<p class="price">$134</p>
												</div>
							...
							<ul class="small-product">
								<li>
									<a href="#" title="Praesent tempor sem sodales">
										<img src=<c:url value="/lib/themes/images/ladies/3.jpg"/> alt="Praesent tempor sem sodales">
									</a>
									<a href="#">Praesent tempor sem</a>
								</li>
								<li>
									<a href="#" title="Luctus quam ultrices rutrum">
										<img src=<c:url value="/lib/themes/images/ladies/4.jpg"/> alt="Luctus quam ultrices rutrum">
									</a>
									<a href="#">Luctus quam ultrices rutrum</a>
								</li>
								<li>
									<a href="#" title="Fusce id molestie massa">
										<img src=<c:url value="/lib/themes/images/ladies/5.jpg"/> alt="Fusce id molestie massa">
									</a>
